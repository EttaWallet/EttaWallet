...
export const formatFeedDate = (timestamp: number, i18next: i18nType) => {
  return quickFormat(timestamp, i18next, 'd MMMM yyyy');
};

export const transactionFeedHeader = (timestamp: number, i18next: i18nType) => {
...
export const humanizeTimestamp = (timestamp: number, i18next: i18nType) => {
